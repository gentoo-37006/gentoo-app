...
a separate repository (`gentoo-37006/kowalski`), ignored by this repository. Commit and push
its changes from within `kowalski/`; do not add it as an embedded repository here.
